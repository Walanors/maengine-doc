...
description: Nanos World-style Lua class hierarchy with Subscribe, BindValue, and Inherit patterns
---

# Class Extension System

MAEngine implements a **Nanos World-style class hierarchy** for Lua scripting. This provides a familiar, object-oriented API with inheritance, events, and reactive value bindings.
...
1. **Familiar to Nanos World developers**: Same API style
